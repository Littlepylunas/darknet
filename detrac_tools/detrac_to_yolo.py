            ...
            for frame in frames:
                ...
                for target in targets:
                    ...
                    if occlusion is not None:
                        ...
                        overlap_width = round(
                            float(region_overlap.attrib['width']))
                        overlap_height = round(
                            float(region_overlap.attrib['height']))
                        occlusion_ratio = (
                            overlap_width * overlap_height) / (width * height)
                    else:
                        occlusion_ratio = 0
        ...
        for sequence in sequences:
            ...
            for frame in frames:
                ...
                if frame_num in frame_list:
                    ...
                    img = Image.open(self.root_images +
                                     sequence + '/' + img_name+'.jpg')
